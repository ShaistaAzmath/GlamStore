...
import Perfumes from "./pages/Fragrance/Perfumes";
import Hairserum from "./pages/Haircare/Hairserums";
import Shampoo from "./pages/Haircare/Shampoo";
import Eyemakeup from "./pages/Makeup/Eyemakeup";
import Facebase from "./pages/Makeup/Facebase";
import Lipstick from "./pages/Makeup/Lipstick";
import Powders from "./pages/Makeup/Powders";
